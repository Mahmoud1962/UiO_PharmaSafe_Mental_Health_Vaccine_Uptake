...
saveRDS(imp_preg_covid_risk, file = "Cov_Imputed_Pregnancy_Covid_Risk.rds")
...
saveRDS(imp_preg_covid_norisk, file = "Cov_Imputed_Pregnancy_Covid_Norisk.rds")
...
saveRDS(imp_preg_flu_norisk, file = "Cov_Imputed_Pregnancy_Influenza_Norisk.rds")
...
saveRDS(imp_preg_flu_risk, file = "Cov_Imputed_Pregnancy_Influenza_risk.rds")
...
saveRDS(imp_old_covid, file = "Cov_Imputed_Old_Covid.rds")
...
saveRDS(imp_old_flu, file = "Cov_Imputed_Old_Influenza.rds")
