################################################################################
# Script: 10.1.Modified_Poisson_SA_Cov.R
#
# Purpose:
...
#   where BMI, education, marital status, and dementia status were 
#   classified as confounders not mediators.
################################################################################
library(lmtest)
library(sandwich)
library(dplyr)
...
save(pooled_results_preg_covid_risk_ADHD, file = "Pooled results/Pregnant_COVID_Risk_ADHD_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_any_mh, file = "Pooled results/Pregnant_COVID_Risk_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_mixed, file = "Pooled results/Pregnant_COVID_Risk_Mixed_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_depression, file = "Pooled results/Pregnant_COVID_Risk_Depression_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_anxiety, file = "Pooled results/Pregnant_COVID_Risk_Anxiety_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_bipolar, file = "Pooled results/Pregnant_COVID_Risk_Bipolar_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_OCD, file = "Pooled results/Pregnant_COVID_Risk_OCD_SA_Cov.rdata")
save(pooled_results_preg_covid_risk_PTSD, file = "Pooled results/Pregnant_COVID_Risk_PTSD_SA_Cov.rdata")
###########################################################################
...
save(pooled_results_preg_covid_norisk_ADHD, file = "Pooled results/Pregnant_COVID_NoRisk_ADHD_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_any_mh, file = "Pooled results/Pregnant_COVID_NoRisk_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_mixed, file = "Pooled results/Pregnant_COVID_NoRisk_Mixed_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_depression, file = "Pooled results/Pregnant_COVID_NoRisk_Depression_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_anxiety, file = "Pooled results/Pregnant_COVID_NoRisk_Anxiety_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_bipolar, file = "Pooled results/Pregnant_COVID_NoRisk_Bipolar_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_OCD, file = "Pooled results/Pregnant_COVID_NoRisk_OCD_SA_Cov.rdata")
save(pooled_results_preg_covid_norisk_PTSD, file = "Pooled results/Pregnant_COVID_NoRisk_PTSD_SA_Cov.rdata")
###########################################################################
...
for(i in 1:30) {
  ...
  model_list_old_flu_any_mh[[i]] <- glm(as.numeric(all.seasons) ~ mental + county_2017 +
                                                    country_of_birth + risk_factor + Education + Dementia + Marital_status 
...
save(pooled_results_old_flu_ADHD, file = "Pooled results/Old_Influenza_ADHD_SA_Cov.rdata")
save(pooled_results_old_flu_any_mh, file = "Pooled results/Old_Influenza_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_old_flu_mixed, file = "Pooled results/Old_Influenza_Mixed_SA_Cov.rdata")
save(pooled_results_old_flu_depression, file = "Pooled results/Old_Influenza_Depression_SA_Cov.rdata")
save(pooled_results_old_flu_anxiety, file = "Pooled results/Old_Influenza_Anxiety_SA_Cov.rdata")
save(pooled_results_old_flu_bipolar, file = "Pooled results/Old_Influenza_Bipolar_SA_Cov.rdata")
save(pooled_results_old_flu_OCD, file = "Pooled results/Old_Influenza_OCD_SA_Cov.rdata")
save(pooled_results_old_flu_PTSD, file = "Pooled results/Old_Influenza_PTSD_SA_Cov.rdata")
#################################################
...
save(pooled_results_preg_flu_risk_ADHD, file = "Pooled results/Pregnant_Influenza_Risk_ADHD_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_any_mh, file = "Pooled results/Pregnant_Influenza_Risk_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_mixed, file = "Pooled results/Pregnant_Influenza_Risk_Mixed_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_depression, file = "Pooled results/Pregnant_Influenza_Risk_Depression_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_anxiety, file = "Pooled results/Pregnant_Influenza_Risk_Anxiety_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_bipolar, file = "Pooled results/Pregnant_Influenza_Risk_Bipolar_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_OCD, file = "Pooled results/Pregnant_Influenza_Risk_OCD_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_PTSD, file = "Pooled results/Pregnant_Influenza_Risk_PTSD_SA_Cov.rdata")
##################################################################
...
save(pooled_results_preg_flu_norisk_ADHD, file = "Pooled results/Pregnant_Influenza_NoRisk_ADHD_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_any_mh, file = "Pooled results/Pregnant_Influenza_NoRisk_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_mixed, file = "Pooled results/Pregnant_Influenza_NoRisk_Mixed_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_depression, file = "Pooled results/Pregnant_Influenza_NoRisk_Depression_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_anxiety, file = "Pooled results/Pregnant_Influenza_NoRisk_Anxiety_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_bipolar, file = "Pooled results/Pregnant_Influenza_NoRisk_Bipolar_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_OCD, file = "Pooled results/Pregnant_Influenza_NoRisk_OCD_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_PTSD, file = "Pooled results/Pregnant_Influenza_NoRisk_PTSD_SA_Cov.rdata")
##################################################################
...
save(pooled_results_preg_flu_risk_ADHD_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_ADHD_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_any_mh_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_AnyMentalHealth_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_mixed_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_Mixed_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_depression_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_Depression_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_anxiety_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_Anxiety_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_bipolar_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_Bipolar_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_OCD_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_OCD_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_PTSD_seasosn1, file = "Pooled results/Pregnant_Influenza_Risk_PTSD_Season1_SA_Cov.rdata")
##############################
...
save(pooled_results_preg_flu_risk_ADHD_season2, file = "Pooled results/Pregnant_Influenza_Risk_ADHD_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_any_mh_season2, file = "Pooled results/Pregnant_Influenza_Risk_AnyMentalHealth_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_mixed_season2, file = "Pooled results/Pregnant_Influenza_Risk_Mixed_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_depression_season2, file = "Pooled results/Pregnant_Influenza_Risk_Depression_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_anxiety_season2, file = "Pooled results/Pregnant_Influenza_Risk_Anxiety_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_bipolar_season2, file = "Pooled results/Pregnant_Influenza_Risk_Bipolar_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_OCD_season2, file = "Pooled results/Pregnant_Influenza_Risk_OCD_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_PTSD_season2, file = "Pooled results/Pregnant_Influenza_Risk_PTSD_season2_SA_Cov.rdata")
###################################
...
save(pooled_results_preg_flu_risk_ADHD_season3, file = "Pooled results/Pregnant_Influenza_Risk_ADHD_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_any_mh_season3, file = "Pooled results/Pregnant_Influenza_Risk_AnyMentalHealth_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_mixed_season3, file = "Pooled results/Pregnant_Influenza_Risk_Mixed_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_depression_season3, file = "Pooled results/Pregnant_Influenza_Risk_Depression_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_anxiety_season3, file = "Pooled results/Pregnant_Influenza_Risk_Anxiety_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_bipolar_season3, file = "Pooled results/Pregnant_Influenza_Risk_Bipolar_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_OCD_season3, file = "Pooled results/Pregnant_Influenza_Risk_OCD_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_risk_PTSD_season3, file = "Pooled results/Pregnant_Influenza_Risk_PTSD_season3_SA_Cov.rdata")
################################################################
to_add <- pregnant_flu_norisk[, c("person_id","Preg_id", "mental", "mixed", "depression_pure",
                                  "anxiety_pure", "bipolar_pure",
...
save(pooled_results_preg_flu_norisk_ADHD_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_ADHD_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_any_mh_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_AnyMentalHealth_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_mixed_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_Mixed_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_depression_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_Depression_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_anxiety_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_Anxiety_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_bipolar_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_Bipolar_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_OCD_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_OCD_Season1_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_PTSD_seasosn1, file = "Pooled results/Pregnant_Influenza_NoRisk_PTSD_Season1_SA_Cov.rdata")
##############################
...
save(pooled_results_preg_flu_norisk_ADHD_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_ADHD_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_any_mh_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_AnyMentalHealth_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_mixed_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_Mixed_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_depression_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_Depression_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_anxiety_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_Anxiety_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_bipolar_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_Bipolar_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_OCD_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_OCD_season2_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_PTSD_season2, file = "Pooled results/Pregnant_Influenza_NoRisk_PTSD_season2_SA_Cov.rdata")
###################################
...
save(pooled_results_preg_flu_norisk_ADHD_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_ADHD_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_any_mh_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_AnyMentalHealth_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_mixed_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_Mixed_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_depression_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_Depression_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_anxiety_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_Anxiety_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_bipolar_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_Bipolar_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_OCD_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_OCD_season3_SA_Cov.rdata")
save(pooled_results_preg_flu_norisk_PTSD_season3, file = "Pooled results/Pregnant_Influenza_NoRisk_PTSD_season3_SA_Cov.rdata")
############################################
...
for(i in 1:30) {
  ...
  old_covid_imp_iptw[[i]] <- old_covid_imp_iptw[[i]] %>% group_by(old_covid_imp_iptw[[i]]$person_id) %>%
...
save(pooled_results_old_covid_ADHD, file = "Pooled results/Old_COVID19_ADHD_SA_Cov.rdata")
save(pooled_results_old_covid_any_mh, file = "Pooled results/Old_COVID19_AnyMentalHealth_SA_Cov.rdata")
save(pooled_results_old_covid_mixed, file = "Pooled results/Old_COVID19_Mixed_SA_Cov.rdata")
save(pooled_results_old_covid_depression, file = "Pooled results/Old_COVID19_Depression_SA_Cov.rdata")
save(pooled_results_old_covid_anxiety, file = "Pooled results/Old_COVID19_Anxiety_SA_Cov.rdata")
save(pooled_results_old_covid_bipolar, file = "Pooled results/Old_COVID19_Bipolar_SA_Cov.rdata")
save(pooled_results_old_covid_OCD, file = "Pooled results/Old_COVID19_OCD_SA_Cov.rdata")
save(pooled_results_old_covid_PTSD, file = "Pooled results/Old_COVID19_PTSD_SA_Cov.rdata")
###########################################################
...
save(pooled_results_old_covid_ADHD, file = "Pooled results/Old_COVID19_ADHD_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_any_mh, file = "Pooled results/Old_COVID19_AnyMentalHealth_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_mixed, file = "Pooled results/Old_COVID19_Mixed_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_depression, file = "Pooled results/Old_COVID19_Depression_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_anxiety, file = "Pooled results/Old_COVID19_Anxiety_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_bipolar, file = "Pooled results/Old_COVID19_Bipolar_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_OCD, file = "Pooled results/Old_COVID19_OCD_Booster1_SA_Cov.rdata")
save(pooled_results_old_covid_PTSD, file = "Pooled results/Old_COVID19_PTSD_Booster1_SA_Cov.rdata")
##########################################################
...
save(pooled_results_old_covid_ADHD, file = "Pooled results/Old_COVID19_ADHD_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_any_mh, file = "Pooled results/Old_COVID19_AnyMentalHealth_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_mixed, file = "Pooled results/Old_COVID19_Mixed_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_depression, file = "Pooled results/Old_COVID19_Depression_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_anxiety, file = "Pooled results/Old_COVID19_Anxiety_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_bipolar, file = "Pooled results/Old_COVID19_Bipolar_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_OCD, file = "Pooled results/Old_COVID19_OCD_Booster2_SA_Cov.rdata")
save(pooled_results_old_covid_PTSD, file = "Pooled results/Old_COVID19_PTSD_Booster2_SA_Cov.rdata")
##########################################################
to_add <- old_flu[, c("person_id", "mental", "mixed", "depression_pure",
                      "anxiety_pure", "bipolar_pure",
...
save(pooled_results_old_flu_ADHD, file = "Pooled results/Old_Influenza_ADHD_season1_SA_Cov.rdata")
save(pooled_results_old_flu_any_mh, file = "Pooled results/Old_Influenza_AnyMentalHealth_season1_SA_Cov.rdata")
save(pooled_results_old_flu_mixed, file = "Pooled results/Old_Influenza_Mixed_season1_SA_Cov.rdata")
save(pooled_results_old_flu_depression, file = "Pooled results/Old_Influenza_Depression_season1_SA_Cov.rdata")
save(pooled_results_old_flu_anxiety, file = "Pooled results/Old_Influenza_Anxiety_season1_SA_Cov.rdata")
save(pooled_results_old_flu_bipolar, file = "Pooled results/Old_Influenza_Bipolar_season1_SA_Cov.rdata")
save(pooled_results_old_flu_OCD, file = "Pooled results/Old_Influenza_OCD_season1_SA_Cov.rdata")
save(pooled_results_old_flu_PTSD, file = "Pooled results/Old_Influenza_PTSD_season1_SA_Cov.rdata")
###############################################################################
...
save(pooled_results_old_flu_ADHD, file = "Pooled results/Old_Influenza_ADHD_season2_SA_Cov.rdata")
save(pooled_results_old_flu_any_mh, file = "Pooled results/Old_Influenza_AnyMentalHealth_season2_SA_Cov.rdata")
save(pooled_results_old_flu_mixed, file = "Pooled results/Old_Influenza_Mixed_season2_SA_Cov.rdata")
save(pooled_results_old_flu_depression, file = "Pooled results/Old_Influenza_Depression_season2_SA_Cov.rdata")
save(pooled_results_old_flu_anxiety, file = "Pooled results/Old_Influenza_Anxiety_season2_SA_Cov.rdata")
save(pooled_results_old_flu_bipolar, file = "Pooled results/Old_Influenza_Bipolar_season2_SA_Cov.rdata")
save(pooled_results_old_flu_OCD, file = "Pooled results/Old_Influenza_OCD_season2_SA_Cov.rdata")
save(pooled_results_old_flu_PTSD, file = "Pooled results/Old_Influenza_PTSD_season2_SA_Cov.rdata")
##############################################################################
...
for(i in 1:30) {
  # Run weighted modified Poisson
  model_list_old_flu_any_mh[[i]] <- glm(as.numeric(season3) ~ mental + county_2017 +
                                          country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                        +  income_2017_cat + age_at_enrollment_categorized, 
                                        family = poisson(link = "log"),
                                        data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_mixed[[i]] <- glm(as.numeric(season3) ~ mixed + county_2017 +
                                         country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                       +  income_2017_cat + age_at_enrollment_categorized, 
                                       family = poisson(link = "log"),
                                       data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_depression[[i]] <- glm(as.numeric(season3) ~ depression_pure + county_2017 +
                                              country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                            +  income_2017_cat + age_at_enrollment_categorized, 
                                            family = poisson(link = "log"),
                                            data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_anxiety[[i]] <- glm(as.numeric(season3) ~ anxiety_pure + county_2017 +
                                           country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                         +  income_2017_cat + age_at_enrollment_categorized, 
                                         family = poisson(link = "log"),
                                         data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_bipolar[[i]] <- glm(as.numeric(season3) ~ bipolar_pure + county_2017 +
                                           country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                         +  income_2017_cat + age_at_enrollment_categorized, 
                                         family = poisson(link = "log"),
                                         data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_PTSD[[i]] <- glm(as.numeric(season3) ~ PTSD_pure + county_2017 +
                                        country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                      +  income_2017_cat + age_at_enrollment_categorized, 
                                      family = poisson(link = "log"),
                                      data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_OCD[[i]] <- glm(as.numeric(season3) ~ OCD_pure + + county_2017 +
                                       country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                     +  income_2017_cat + age_at_enrollment_categorized, 
                                     family = poisson(link = "log"),
                                     data = old_flu_imp_iptw[[i]],
  ...
  # Run weighted modified Poisson
  model_list_old_flu_ADHD[[i]] <- glm(as.numeric(season3) ~ ADHD_pure + county_2017 +
                                        country_of_birth + risk_factor + Education + Dementia + Marital_status 
                                      +  income_2017_cat + age_at_enrollment_categorized, 
                                      family = poisson(link = "log"),
                                      data = old_flu_imp_iptw[[i]],
...
save(pooled_results_old_flu_ADHD, file = "Pooled results/Old_Influenza_ADHD_season3_SA_Cov.rdata")
save(pooled_results_old_flu_any_mh, file = "Pooled results/Old_Influenza_AnyMentalHealth_season3_SA_Cov.rdata")
save(pooled_results_old_flu_mixed, file = "Pooled results/Old_Influenza_Mixed_season3_SA_Cov.rdata")
save(pooled_results_old_flu_depression, file = "Pooled results/Old_Influenza_Depression_season3_SA_Cov.rdata")
save(pooled_results_old_flu_anxiety, file = "Pooled results/Old_Influenza_Anxiety_season3_SA_Cov.rdata")
save(pooled_results_old_flu_bipolar, file = "Pooled results/Old_Influenza_Bipolar_season3_SA_Cov.rdata")
save(pooled_results_old_flu_OCD, file = "Pooled results/Old_Influenza_OCD_season3_SA_Cov.rdata")
save(pooled_results_old_flu_PTSD, file = "Pooled results/Old_Influenza_PTSD_season3_SA_Cov.rdata")
##############################################################################
...
old_flu_season2_RR <- c(1.09,1.11,1.09,1.13,0.97,1.30,0.95,1.01)
old_flu_season2_LCI <- c(1.04,1.01,1.04,1.05,0.87,1.08,0.8,0.66)
old_flu_season2_UCI <- c(1.15,1.22,1.74,1.21,1.08,1.50,1.28,1.53)

old_flu_season3_RR <- c(1.07,1.08,1.07,1.08,0.95,1.29,0.97,1.12)
old_flu_season3_LCI <- c(1.03,1,1.03,1.02,0.87,1.15,0.84,0.84)
old_flu_season3_UCI <- c(1.12,1.17,1.12,1.15,1.04,1.50,1.11,1.5)
...
preg_flu_risk_season1_UCI <- c(1.15,1,50,0.57,0.29,0,0.64,0,0.66)
...
preg_flu_norisk_season3_LCI <- c(1.30,1.29,1.32,1.57,1.42,1.8,2.62,1.61)
